...
class HockeyPlayerCardDrescription extends CardDescription<number, MaterialType, LocationType, HockeyPlayerCard> {
  height = 8.7
  width = 5.6
  images = {
...
export const hockeyPlayerCardDrescription = new HockeyPlayerCardDrescription()
